...
UeListM* get_ue_list(){
    ...
    for(int i = 0; i<num_ues; i++){
        ...
        ue_info_list[i]->has_avg_rsrp = 1;
        ue_info_list[i]->avg_rsrp = stats->num_rsrp_meas > 0 ? stats->cumul_rsrp / stats->num_rsrp_meas : 0;

        ue_info_list[i]->has_ph = 1;
        ue_info_list[i]->ph = sched_ctrl->ph;
        ue_info_list[i]->has_pcmax = 1;
        ue_info_list[i]->pcmax = sched_ctrl->pcmax;

        ue_info_list[i]->has_dl_total_bytes = 1;
        ue_info_list[i]->dl_total_bytes = stats->dl.total_bytes;
        ue_info_list[i]->has_dl_errors = 1;
        ue_info_list[i]->dl_errors = stats->dl.errors;
        ue_info_list[i]->has_dl_bler = 1;
        ue_info_list[i]->dl_bler = sched_ctrl->dl_bler_stats.bler;
        ue_info_list[i]->has_dl_mcs = 1;
        ue_info_list[i]->dl_mcs = sched_ctrl->dl_bler_stats.mcs;

        ue_info_list[i]->has_ul_total_bytes = 1;
        ue_info_list[i]->ul_total_bytes = stats->ul.total_bytes;
        ue_info_list[i]->has_ul_errors = 1;
        ue_info_list[i]->ul_errors = stats->ul.errors;
        ue_info_list[i]->has_ul_bler = 1;
        ue_info_list[i]->ul_bler = sched_ctrl->ul_bler_stats.bler;
        ue_info_list[i]->has_ul_mcs = 1;
        ue_info_list[i]->ul_mcs = sched_ctrl->ul_bler_stats.mcs;
